...
with open(player_data / "Input-P0-0", "w") as f:
    ...
    f.write(f"3" + separator + "1" + separator + "11" + separator + "0\n")
    f.write(f"3" + separator + "0" + separator + "0" + separator + "1\n")
    f.write(f"2" + separator + "1" + separator + "7" + separator + "0\n")
    f.write(f"2" + separator + "0" + separator + "0" + separator + "2\n")
    f.write(f"4" + separator + "0" + separator + "0" + separator + "3\n")
    f.write(f"4" + separator + "1" + separator + "8" + separator + "0\n")
    f.write(f"4" + separator + "1" + separator + "6" + separator + "0\n")


    
    for i in range(7,numrows):
    	f.write(f"0"+separator +"0"+separator+"0"+separator +"0\n" )


print(f"wrote {numrows} rows")
print(f"output should be breakdown 1: 11, breakdown 2: 7, breakdown 3: 14")
